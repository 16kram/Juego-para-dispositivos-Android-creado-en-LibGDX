...
import cat.xtec.ioc.SprayTheBugs;
...
public class SplashScreen implements Screen {
    ...
    private Stage stage;
    private SprayTheBugs game;

    private Label.LabelStyle textStyle;
    private Label textLbl;
    private Label puntMax;
    private Preferences prefs;

    public SplashScreen(SprayTheBugs game) {
        ...
        textLbl = new Label("Spray the bugs", textStyle);

        prefs=Gdx.app.getPreferences("prefs");
        int puntuacionMaxima=prefs.getInteger("puntMax");
        //Añadimos la puntuación máxima en la pantalla de inicio
        puntMax=new Label("HIGH SCORE: "+puntuacionMaxima,textStyle);
        puntMax.setPosition(Settings.GAME_WIDTH/2-puntMax.getWidth()/2,4);
        stage.addActor(puntMax);
        ...
        Image spacecraft = new Image(AssetManager.robot);
